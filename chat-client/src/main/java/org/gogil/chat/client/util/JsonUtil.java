package org.gogil.chat.client.util;
    ...
    public static Message parseMessage(String json) {
        ...
        switch (type) {
            ...
            case HISTORY_MESSAGE:
                return gson.fromJson(json, HistoryMessage.class);
            case ROOM_LIST:
                return gson.fromJson(json, RoomListMessage.class);
            case USER_LIST:
                return gson.fromJson(json, UserListMessage.class);
            default:
